...
List<ContactInfo> contactInfoFromJson(String str) => List<ContactInfo>.from(
    json.decode(str).map((x) => ContactInfo.fromJson(x)));

String contactInfoToJson(List<ContactInfo> data) =>
