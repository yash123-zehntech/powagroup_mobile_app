...
//
//     final invoiceInfo = invoiceInfoFromJson(jsonString);
...
List<InvoiceInfo> invoiceInfoFromJson(String str) => List<InvoiceInfo>.from(
    json.decode(str).map((x) => InvoiceInfo.fromJson(x)));

String invoiceInfoToJson(List<InvoiceInfo> data) =>
