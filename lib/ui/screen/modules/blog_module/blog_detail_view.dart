        ...
        viewModel.isBusy || viewModel.productDetails.id == null
            ...
            : ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  imageUrl: ApiClient.BASE_URL + widget.blogPost!.imageUrl!,
                  fit: BoxFit.cover,
                  width: double.infinity,
                  height: 190.h,
                    ...
                    children: [
                      Text(
                        viewModel.productDetails.name != null &&
                            ...
                            ? viewModel.productDetails.name.toString()
                            : '',
                        style: TextStyle(
                            fontFamily: 'Raleway',
          ...
          child: viewModel.isBusy || viewModel.productDetails.id == null
              ...
              : Padding(
                  ...
                  child: Wrap(
                    children: [
                      // Text(
                      //   viewModel.productDetails.content != null &&
                      //           viewModel.productDetails.content!.isNotEmpty
                      //       ? viewModel.productDetails.content.toString()
                      //       : '',
                      //   style: TextStyle(
                      //       fontFamily: 'Raleway',
                      //       fontSize: Globlas.deviceType == "phone" ? 18 : 28,
                      ...
                      // ),
                      Html(
                        data: viewModel.productDetails.content != null &&
                                viewModel.productDetails.content!.isNotEmpty
                            ? viewModel.productDetails.content.toString()
                            : '',
                        shrinkWrap: true,
    ...
    return viewModel.isBusy || viewModel.productDetails.id == null
        ...
        : Padding(
            padding:
                const EdgeInsets.only(left: 24, bottom: 3, top: 5, right: 8),
            child: Text(
              viewModel.productDetails.subTitle != null &&
                      viewModel.productDetails.subTitle!.isNotEmpty
                  ? viewModel.productDetails.subTitle.toString()
                  : '',
              style: TextStyle(
                  fontFamily: 'Raleway',
