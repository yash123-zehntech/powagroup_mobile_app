...
import 'package:powagroup/ui/screen/modules/user_module/forgot_password/forgot_password_model.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      ...
      Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: const Color(0xffC6F2E7).withOpacity(0.0),
            automaticallyImplyLeading: false,
            elevation: 0,
          ),
          body: ViewModelBuilder<ForgotPasswordViewMode>.reactive(
              viewModelBuilder: () => ForgotPasswordViewMode(),
                    ...
                    children: <Widget>[
                      Column(
                        ...
                        children: [
                          ...
                          headerSubContent('Enter Your register Email Address',
                      ...
                      Container(
                        ...
                        child: ListView(
                          ...
                          children: [
                            getForgotPasswordForm(context, viewModel),
                            SizedBox(
                              height: 20.h,
                            ),
                            InkWell(
                              onTap: () {
                                viewModel.onSendVerificationButtonClick();
                              },
                              child: ButtonWidget(
...
//retrun  email text field for password
  Widget getForgotPasswordForm(context, ForgotPasswordViewMode viewModel) =>
      Form(
