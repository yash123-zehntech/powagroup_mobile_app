...
import 'package:powagroup/ui/screen/modules/home_module/product_sub_subcategory_module/product_sub_subcategory_view_model.dart';
...
class ProductSubSubCategoryView extends StatelessWidget {
  Category? categoryObj;
  List<Category>? subCategoryList;
  ProductSubSubCategoryView(
      {Key? key, @required this.categoryObj, @required this.subCategoryList})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<ProductSubSubCategoryViewModel>.reactive(
      viewModelBuilder: () => ProductSubSubCategoryViewModel(),
  ...
  Widget productCategoriesList(ProductSubSubCategoryViewModel viewModel) {
    return Expanded(
  ...
  Widget productCategoryItem(ProductSubSubCategoryViewModel viewModel,
      int index, BuildContext context) {
    return InkWell(
      onTap: () {
        viewModel.onProductSubSubCategoryItemClick(
